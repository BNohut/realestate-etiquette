            ...
            <div id="kt_aside" class="aside py-9" data-kt-drawer="true" data-kt-drawer-name="aside"
                ...
                <div class="aside-logo flex-column-auto px-9 mb-9" id="kt_aside_logo">
                    ...
                    <a href="../../demo3/dist/index.html">
                        <img alt="Logo" src="{{ asset('dist/assets/media/logos/demo3.svg') }}"
                            class="h-20px logo theme-light-show" />
                        <img alt="Logo" src="{{ asset('dist/assets/media/logos/demo3-dark.svg') }}"
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-inner flex-column collapse"
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo3/dist/dashboards/website-analytics.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo3/dist/dashboards/finance-performance.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo3/dist/dashboards/store-analytics.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/user-profile/overview.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/user-profile/projects.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Projects</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/user-profile/campaigns.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/user-profile/documents.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/user-profile/followers.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/user-profile/activity.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/corporate/sign-in.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/corporate/sign-up.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/corporate/two-steps.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/corporate/reset-password.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/corporate/new-password.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/overlay/sign-in.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-in</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/overlay/sign-up.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-up</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/overlay/two-steps.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Two-steps</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/overlay/reset-password.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Reset Password</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/overlay/new-password.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">New Password</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/creative/sign-in.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-in</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/creative/sign-up.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-up</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/creative/two-steps.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Two-steps</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/creative/reset-password.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Reset Password</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/creative/new-password.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">New Password</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/fancy/sign-in.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-in</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/fancy/sign-up.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-up</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/fancy/two-steps.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Two-steps</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/fancy/reset-password.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Reset Password</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/layouts/fancy/new-password.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">New Password</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/email/welcome-message.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/email/reset-password.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Reset Password</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/email/subscription-confirmed.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/email/card-declined.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/email/promo-1.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/email/promo-2.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/authentication/email/promo-3.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/authentication/extended/two-factor-auth.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/authentication/general/coming-soon.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/authentication/general/account-deactivated.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/social/activity.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/social/followers.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Followers</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/social/settings.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Settings</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/pages/pricing/column.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/projects/project.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/projects/targets.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/projects/budget.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/projects/activity.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Activity</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/projects/settings.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Settings</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/catalog/products.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/catalog/categories.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/catalog/add-product.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/catalog/add-category.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/catalog/edit-category.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/sales/listing.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/sales/details.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/sales/add-order.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/sales/edit-order.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/customers/listing.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/customers/details.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/reports/view.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/reports/sales.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sales</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/reports/returns.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/reports/customer-orders.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/ecommerce/reports/shipping.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/ecommerce/settings.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Settings</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/contacts/getting-started.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/contacts/add-contact.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/contacts/edit-contact.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/contacts/view-contact.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/support-center/overview.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Overview</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/support-center/faq.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">FAQ</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/support-center/licenses.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Licenses</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/support-center/contact.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Contact Us</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/customers/list.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Customer Listing</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/customers/view.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Customer Details</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/subscriptions/list.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/subscriptions/add.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/subscriptions/view.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/apps/invoices/view/invoice-3.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/invoices/create.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/file-manager/folders.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/file-manager/files.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Files</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/file-manager/blank.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/file-manager/settings.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Settings</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/inbox/listing.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/apps/inbox/compose.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/general/invite-friends.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/general/view-users.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/general/select-users.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/general/upgrade-plan.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/general/share-earn.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/forms/new-target.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/forms/new-card.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/forms/new-address.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/forms/create-api-key.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/forms/bidding.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Bidding</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/wizards/create-app.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/wizards/create-campaign.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/wizards/create-account.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/wizards/create-project.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/wizards/top-up-wallet.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/wizards/offer-a-deal.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/wizards/two-factor-authentication.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Two Factor Auth</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/search/users.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Users</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="../../demo3/dist/utilities/modals/search/select-location.html">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/wizards/horizontal.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/wizards/vertical.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/wizards/two-factor-authentication.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Two Factor Auth</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/wizards/create-app.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Create App</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/wizards/create-campaign.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Create Campaign</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/wizards/create-account.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/wizards/create-project.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Create Project</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/wizards/offer-a-deal.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Offer a Deal</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/search/horizontal.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Horizontal</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/search/vertical.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Vertical</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/search/users.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Users</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="../../demo3/dist/utilities/search/select-location.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="https://preview.keenthemes.com/metronic8/demo3/layout-builder.html"
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-circle symbol-40px">
                                <img src="{{ asset('dist/assets/media/avatars/300-1.jpg') }}" alt="photo" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::User info-->
                            <div class="ms-2">
                                <!--begin::Name-->
                                <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bold lh-1">Paul
                                    Melone</a>
                                <!--end::Name-->
                                <!--begin::Major-->
                        ...
                        <div class="ms-1">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-item px-5">
                                    <a href="../../demo3/dist/account/overview.html" class="menu-link px-5">My
                                        Profile</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="../../demo3/dist/account/billing.html"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="../../demo3/dist/account/statements.html" class="menu-link px-5">My
                                        Statements</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu separator-->
                                        ...
                                        <span class="menu-title position-relative">Language
                                            <span
                                                ...
                                                <img class="w-15px h-15px rounded-1 ms-2"
                                                    src="{{ asset('dist/assets/media/flags/united-states.svg') }}"
                                                    alt="" /></span></span>
                                    </a>
                                    <!--begin::Menu sub-->
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="../../demo3/dist/account/settings.html"
                                                ...
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1"
                                                        src="{{ asset('dist/assets/media/flags/spain.svg') }}"
                                                        alt="" />
                                                </span>Spanish</a>
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="../../demo3/dist/account/settings.html"
                                                ...
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1"
                                                        src="{{ asset('dist/assets/media/flags/germany.svg') }}"
                                                        alt="" />
                                                </span>German</a>
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="../../demo3/dist/account/settings.html"
                                                ...
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1"
                                                        src="{{ asset('dist/assets/media/flags/japan.svg') }}"
                                                        alt="" />
                                                </span>Japanese</a>
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="../../demo3/dist/account/settings.html"
                                                ...
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1"
                                                        src="{{ asset('dist/assets/media/flags/france.svg') }}"
                                                        alt="" />
                                                </span>French</a>
                                        </div>
                                        <!--end::Menu item-->
                                            ...
                                            <div class="scroll-y mh-200px mh-lg-350px">
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src="{{ asset('dist/assets/media/avatars/300-6.jpg') }}"
                                                            alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src="{{ asset('dist/assets/media/avatars/300-2.jpg') }}"
                                                            alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src="{{ asset('dist/assets/media/avatars/300-9.jpg') }}"
                                                            alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src="{{ asset('dist/assets/media/avatars/300-14.jpg') }}"
                                                            alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-40px me-4">
                                                        <img src="{{ asset('dist/assets/media/avatars/300-11.jpg') }}"
                                                            alt="" />
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src="{{ asset('dist/assets/media/svg/brand-logos/volicity-9.svg') }}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src="{{ asset('dist/assets/media/svg/brand-logos/tvit.svg') }}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src="{{ asset('dist/assets/media/svg/misc/infography.svg') }}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src="{{ asset('dist/assets/media/svg/brand-logos/leaf.svg') }}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
                                                        <span class="symbol-label bg-light">
                                                            <img class="w-20px h-20px"
                                                                src="{{ asset('dist/assets/media/svg/brand-logos/tower.svg') }}"
                                                                alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        ...
                        <div class="row gy-5 g-xl-10">
                                ...
                                <div class="card card-xl-stretch mb-xl-10 theme-dark-bg-body"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-dark text-hover-primary fw-bold fs-3">Earnings</a>
                                            <!--end::Title-->
                                            <!--begin::Chart-->
                                ...
                                <div class="card card-xxl-stretch mb-xl-10 theme-dark-bg-body"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-dark text-hover-primary fw-bold fs-3">Contributors</a>
                                            <!--end::Title-->
                                            <!--begin::Chart-->
                            ...
                            <div class="col-xl-4">
                                <!--begin::Mixed Widget 14-->
                                <div class="card card-xxl-stretch mb-5 mb-xl-10 theme-dark-bg-body"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="d-flex flex-column mb-7">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-dark text-hover-primary fw-bold fs-3">Summary</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Wrapper-->
                                        <!--begin::Row-->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="text-muted fw-semibold text-muted d-block fs-7">Web,
                                                        UI/UX Design</span>
                                                </td>
                                                <td class="text-end">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-45px me-5">
                                                            <img src="{{ asset('dist/assets/media/avatars/300-5.jpg') }}"
                                                                alt="" />
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-45px me-5">
                                                            <img src="{{ asset('dist/assets/media/avatars/300-20.jpg') }}"
                                                                alt="" />
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-45px me-5">
                                                            <img src="{{ asset('dist/assets/media/avatars/300-23.jpg') }}"
                                                                alt="" />
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                    ...
                                    <div class="card-header align-items-center border-0 mt-4">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                data-kt-menu="true" id="kt_menu_63de77131b758">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <div>
                                                            <select class="form-select form-select-solid"
                                                                ...
                                                                data-dropdown-parent="#kt_menu_63de77131b758"
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-10">
                                    ...
                                    <div class="card-body pt-5">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <span class="symbol-label">
                                                    <img src="{{ asset('dist/assets/media/svg/brand-logos/plurk.svg') }}"
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <span class="symbol-label">
                                                    <img src="{{ asset('dist/assets/media/svg/brand-logos/telegram.svg') }}"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <span class="symbol-label">
                                                    <img src="{{ asset('dist/assets/media/svg/brand-logos/vimeo.svg') }}"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <span class="symbol-label">
                                                    <img src="{{ asset('dist/assets/media/svg/brand-logos/bebo.svg') }}"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <span class="symbol-label">
                                                    <img src="{{ asset('dist/assets/media/svg/brand-logos/kickstarter.svg') }}"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                    ...
                                    <div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
                                        ...
                                        <div class="card-header align-items-center border-0">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <!--begin::Menu 1-->
                                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                    data-kt-menu="true" id="kt_menu_63de77131d9ca">
                                                    <!--begin::Header-->
                                                    <div class="px-7 py-5">
                                                        <div class="fs-5 text-dark fw-bold">Filter Options</div>
                                                    </div>
                                                        ...
                                                        <div class="mb-10">
                                                            ...
                                                            <div>
                                                                <select class="form-select form-select-solid"
                                                                    data-kt-select2="true"
                                                                    data-placeholder="Select option"
                                                                    data-dropdown-parent="#kt_menu_63de77131d9ca"
                                                                    data-allow-clear="true">
                                                                    <option></option>
                                                                    <option value="1">Approved</option>
                                                                    <option value="2">Pending</option>
                                        ...
                                        <div class="card-body py-0">
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="#"
                                                        class="text-white text-hover-primary fs-6 fw-bold">Project
                                                        Briefing</a>
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="#"
                                                        class="text-white text-hover-primary fs-6 fw-bold">Concept
                                                        Design</a>
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="#"
                                                        class="text-white text-hover-primary fs-6 fw-bold">Functional
                                                        Logics</a>
                                        ...
                                        <div class="card-body py-0">
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                ...
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-20.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Premium
                                                        Coffee</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">Arabica
                                                        Specialty Brand</span>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Item-->
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                <!--begin::Image-->
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-25.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Light
                                                        Sneakers</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">The Best
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                <!--begin::Image-->
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-24.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Red
                                                        Boots</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">All Season
                                                        Boots</span>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                <!--begin::Image-->
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-19.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Wall
                                                        Decoration</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">Creative &
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center">
                                                <!--begin::Image-->
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-27.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Home
                                                        Confort</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">Smart Air
                                                        Purifier</span>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                    ...
                                    <div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                <!--begin::Image-->
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-1.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Spotify
                                                        App</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">HTML, SASS,
                                                        Bootstrap</span>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                <!--begin::Image-->
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-2.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Fitnes
                                                        Drive</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">Angular,
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                <!--begin::Image-->
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-3.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Taskify
                                                        App</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">HTML, CSS.
                                                        jQuery</span>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center mb-7">
                                                <!--begin::Image-->
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-5.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Calendr
                                                        App</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">React,
                                                        MangoDb. Node</span>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            ...
                                            <div class="d-flex flex-nowrap align-items-center">
                                                <!--begin::Image-->
                                                <div class="symbol symbol-40px symbol-2by3 me-4">
                                                    <img src="{{ asset('dist/assets/media/stock/600x400/img-6.jpg') }}"
                                                        alt="" class="mw-100" />
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-semibold text-hover-primary fs-6">Stocked
                                                        SaaS</a>
                                                    <span class="sidebar-text-muted fw-semibold fs-7 my-1">PHP,
                                                        Laravel, Oracle</span>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            ...
                                            <div class="row g-5">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div
                                                        ...
                                                        <!--begin::Value-->
                                                        <!--begin::Label-->
                                                        <div class="sidebar-text-muted fs-6 fw-bold">System Alert
                                                        </div>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Item-->
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div
                                                        ...
                                                        <!--begin::Value-->
                                                        <!--begin::Label-->
                                                        <div class="sidebar-text-muted fs-6 fw-bold">User Feedback
                                                        </div>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Item-->
                                    ...
                                    <div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
                                        ...
                                        <div class="card-header align-items-center border-0">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <!--begin::Menu 1-->
                                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                    data-kt-menu="true" id="kt_menu_63de77131f129">
                                                    <!--begin::Header-->
                                                    <div class="px-7 py-5">
                                                        <div class="fs-5 text-dark fw-bold">Filter Options</div>
                                                    </div>
                                                        ...
                                                        <div class="mb-10">
                                                            ...
                                                            <div>
                                                                <select class="form-select form-select-solid"
                                                                    data-kt-select2="true"
                                                                    data-placeholder="Select option"
                                                                    data-dropdown-parent="#kt_menu_63de77131f129"
                                                                    data-allow-clear="true">
                                                                    <option></option>
                                                                    <option value="1">Approved</option>
                                                                    <option value="2">Pending</option>
                                    ...
                                    <div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
                                        ...
                                        <div class="card-header align-items-center border-0">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <!--begin::Menu 1-->
                                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                    data-kt-menu="true" id="kt_menu_63de77131f682">
                                                    <!--begin::Header-->
                                                    <div class="px-7 py-5">
                                                        <div class="fs-5 text-dark fw-bold">Filter Options</div>
                                                    </div>
                                                        ...
                                                        <div class="mb-10">
                                                            ...
                                                            <div>
                                                                <select class="form-select form-select-solid"
                                                                    data-kt-select2="true"
                                                                    data-placeholder="Select option"
                                                                    data-dropdown-parent="#kt_menu_63de77131f682"
                                                                    data-allow-clear="true">
                                                                    <option></option>
                                                                    <option value="1">Approved</option>
                                                                    <option value="2">Pending</option>
    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
        ...
        <div class="card shadow-none border-0 rounded-0">
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('dist/assets/media/avatars/300-1.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="" class="w-30px me-3"
                                                src="{{ asset('dist/assets/media/svg/files/pdf.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="../../demo3/dist/apps/projects/project.html"
                                                class="w-30px me-3"
                                                src="{{ asset('dist/assets/media/svg/files/doc.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            ...
                                            <img alt="../../demo3/dist/apps/projects/project.html"
                                                class="w-30px me-3"
                                                src="{{ asset('dist/assets/media/svg/files/css.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('dist/assets/media/stock/600x400/img-29.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('dist/assets/media/stock/600x400/img-31.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('dist/assets/media/stock/600x400/img-40.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('dist/assets/media/avatars/300-4.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="../../demo3/dist/pages/user-profile/activity.html"
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ asset('dist/assets/media/avatars/300-25.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="../../demo3/dist/apps/ecommerce/sales/details.html"
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('dist/assets/media/stock/600x400/img-1.jpg') }}" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('dist/assets/media/stock/600x400/img-3.jpg') }}" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('dist/assets/media/stock/600x400/img-8.jpg') }}" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('dist/assets/media/stock/600x400/img-26.jpg') }}" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('dist/assets/media/stock/600x400/img-21.jpg') }}" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('dist/assets/media/stock/600x400/img-34.jpg') }}" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('dist/assets/media/stock/600x400/img-27.jpg') }}" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="{{ asset('dist/assets/media/svg/brand-logos/google-icon.svg') }}"
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('dist/assets/media/avatars/300-6.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('dist/assets/media/avatars/300-9.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('dist/assets/media/avatars/300-23.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('dist/assets/media/avatars/300-12.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('dist/assets/media/avatars/300-13.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('dist/assets/media/avatars/300-21.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                        ...
                        <div class="py-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="{{ asset('dist/assets/media/illustrations/dozzy-1/1.png') }}"
